            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active: searchParams.order.indexOf('1')!=-1}" @click="changeOrder('1')">
                  <a>综合<span v-show="searchParams.order.indexOf('1')!=-1" class="iconfont" :class="{'icon-down':isDesc,'icon-Up':isAcs}"></span></a>
                </li>
                <li :class="{active: searchParams.order.indexOf('2')!=-1}" @click="changeOrder('2')">
                  <a>价格<span v-show="searchParams.order.indexOf('2')!=-1" class="iconfont" :class="{'icon-down':isDesc,'icon-Up':isAcs}"></span></a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a  title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">{{good.title}}</a>
                  </div>
                  <div class="commit">
...
//     收集平台属性地方回调函数（自定义事件）
      attrInfo(attr,attrValue){
        ...
        //  数组去重
        if(this.searchParams.props.indexOf(props)==-1){this.searchParams.props.push(props),this.getData();}
